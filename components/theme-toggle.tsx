    ...
    >
      <svg xmlns='http://www.w3.org/2000/svg' aria-hidden='true' fill='currentColor' strokeLinecap='round' viewBox='0 0 32 32'>
        <clipPath id='skiper-btn-2'>
          <motion.path animate={{ y: isLight ? 10 : 0, x: isLight ? -12 : 0 }} transition={{ ease: 'easeInOut', duration: 0.35 }} d='M0-5h30a1 1 0 0 0 9 13v24H0Z' />
        </clipPath>
        <g clipPath='url(#skiper-btn-2)'>
          <motion.circle animate={{ r: isLight ? 10 : 8 }} transition={{ ease: 'easeInOut', duration: 0.35 }} cx='16' cy='16' />
          <motion.g
            animate={{
